...
export default function Login() {
  ...
  return (
    <main style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh', padding: '20px', backgroundColor: 'var(--gray-100)' }}>
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <h2 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--dark-color)' }}>Sign in to your account</h2>
          <p style={{ color: 'var(--secondary-color)', fontSize: '14px', marginTop: '5px' }}>Welcome back! Please enter your details.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '25px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
              ...
              <a href="#" style={{ color: 'var(--primary-color)', fontSize: '13px', fontWeight: 500 }}>Forgot password?</a>
            </div>
